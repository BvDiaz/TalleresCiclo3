...
object SumaReactivaNumeros extends App{
  ...
  val suma = Signal{calificaciones.value.sum}

  calificaciones.set(calificaciones.now :+ 10)

  val observer = suma.observe{ valor =>
...
```
<img width="1919" height="1010" alt="image" src="https://github.com/user-attachments/assets/31d91737-215a-46f3-a9e6-4a63ef039bdf" />
...
```
<img width="1919" height="1006" alt="image" src="https://github.com/user-attachments/assets/f7472c65-eda3-44d7-acfb-43ca092a4961" />
