...
**Python ya que es un lenguaje mas sencillo y natural de comprender con una estructura simple de seguir y evitar mas errores al tener una sintaxis simple.**
